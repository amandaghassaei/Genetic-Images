...
int numPlateau = 100;//number of generations w/o a new best match before we add another gene into the mix, doesn't matter if currentNumGenes == totalNumGenes
...
int populationSize = 15;//number of individuals in a population
//display options
...
void setup(){
  ...
  Individual worstPossibleIndividual = new Individual(noGenes, true, true);//all black - no polygons
